...
from nn_ood.posteriors import LocalEnsemble, SCOD, Naive, KFAC
...
test_dataset_args = ['val', 'cifar10c:shot_noise:0','cifar10c:shot_noise:2','cifar10c:shot_noise:4']
...
prep_unc_models = {
    ...
    #     }
    # },
    # 'scod_SRFT_s184_n30_freeze_0.85_onlycorrect': {
    #     'class': SCOD,
    #     'kwargs': {
    #         'num_samples': 184,
    #         'num_eigs': 30,
...
test_unc_models = {
    ...
    'SCOD (T=76,k=12)_onlycorrect': {
        ...
        'load_name': 'scod_SRFT_s76_n12_onlycorrect',
        'forward_kwargs': {
            'n_eigs': 12,
        }
    },
    ...
    #         'device':'gpu',
    #     },
    #     'load_name': 'scod_SRFT_s76_n12_calibrated',
    #     'forward_kwargs': {
    #         'n_eigs': 12,
    #     }
    # },
    ...
    #     }
    # },
    # 'SCOD_freeze_0.85 (T=184,k=30)_onlycorrect': {
    #     'class': SCOD,
    #     'kwargs': {
    #         'num_eigs': 30,
    #         'device':'gpu',
    #     },
    #     'freeze': 0.85,
    #     'load_name': 'scod_SRFT_s184_n30_freeze_0.85_onlycorrect',
    #     'forward_kwargs': {
    #         'n_eigs': 30,
    #     }
    # },
    ...
    #     },
    #     'freeze': 0.85,
    #     'load_name': 'scod_SRFT_s184_n30_freeze_0.85_calibrated',
    #     'forward_kwargs': {
    #         'n_eigs': 30,
    #     }
    # },
...
from nn_ood.utils.viz import summarize_ood_results_by_error, summarize_ood_results, plot_perf_vs_runtime
...
plots_to_generate = {
    'auroc_vs_runtime.pdf': {
        ...
        'title': "CIFAR10 - error based",
    },
}

for split in test_dataset_args[1:4]:
    plot = {
        ...
        'title': "In: CIFAR10-Val" + " | Out: " + split,
    }
